...
export const quizData = [
  ...
  {
    id: '2',
    question: 'сколько курильщик тратит в год на зажигалки?',
    rightAnswer: {
      title: 'На зажигалки в год тратится в среднем 2 000 ₽',
      whiteSubText:
    ...
    answers: [
      {
        id: 'a',
        text: 'до 1 000 ₽',
        wrongText: 'В год на зажигалки тратится в среднем 2 000 ₽',
      },
      {
        id: 'b',
        text: 'от 1 000 ₽ до 2 000 ₽',
        wrongText: 'В год на зажигалки тратится в среднем 2 000 ₽',
      },
      {
        id: 'c',

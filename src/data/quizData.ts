...
export const quizData = [
  ...
  },
  {
    ...
    rightAnswer: {
      title:
        'У Вас есть возможность оценить преимущества IQOS 3 DUOS, воспользовавшись сервисом аренды устройства от 7 дней всего за 10 ₽',
    },
    answers: [
      {
        id: 'a',
      ...
      },
      {
        ...
        icon: Tworub,
        text: '100 ₽',
        wrongText: 'Аренда устройства IQOS 3 DUOS от 7 дней стоит 10 рублей',
      },
      {
        id: 'c',
        icon: Threerub,
